    ...
    <div className="in-page">
      ...
      <main id="main-content">
        ...
        <article className="in-article">
          ...
          <p>Gene Keys is evolutionary. It takes the same gates and reads them as a spectrum — Shadow, Gift, Siddhi — for four specific sequences: your <strong>Life's Work</strong>, your <strong>Evolution</strong>, your <strong>Radiance</strong>, and your <strong>Purpose</strong>. The Shadow isn't a flaw. It's the same energy operating at the frequency of fear, before it's released into the Gift — and eventually, at its fullest expression, the Siddhi.</p>
