          ...
          <div className="sp-journal-card">
            ...
            <div className="sp-journal-card-body">
              ...
              <ul className="sp-journal-bullets">
                ...
                <li><span><strong>365 daily prompts</strong> written specifically for your shadow patterns, genetic gifts, and structural design — zero recycled questions</span></li>
