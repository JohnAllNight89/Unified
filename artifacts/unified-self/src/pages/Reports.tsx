...
export default function Reports() {
  useSEO({
    title: "Soul Blueprint Reports & Readings from The Unified Spirit",
          ...
          <div className="rp-product-primary">
            ...
            <div className="rp-product-body">
              ...
              <ul className="rp-checks">
                ...
                <li>Gene Keys: Life's Work, Evolution, Radiance, Purpose, moving from Shadow through Gift toward Siddhi</li>
