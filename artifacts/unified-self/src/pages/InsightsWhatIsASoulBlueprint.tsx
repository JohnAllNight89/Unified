...
export default function InsightsWhatIsASoulBlueprint() {
  useSEO({
    ...
    description: "A true Soul Blueprint is not another reading of one system. It's the deliberate synthesis of Numerology, Western Astrology, Vedic Astrology, Human Design, and Gene Keys into one coherent portrait of who you were designed to be.",
    ...
    <div className="in-page">
      ...
      <main id="main-content">
        ...
        <article className="in-article">
          ...
          <p>That gap is not a flaw in any single system. It's the absence of synthesis.</p>

          <h2>What a Soul Blueprint actually is</h2>

          <p>A true Soul Blueprint is not another reading of one system. It is the deliberate weaving of five complete wisdom systems — <strong>Numerology, Western Astrology, Vedic Astrology, Human Design, and Gene Keys</strong> — into one coherent, living portrait of who you were designed to be.</p>
          ...
          <p>None of these systems was designed to see what the others see. That's not a weakness — it's the reason each one is precise within its own domain. But it means a single reading, however accurate, is a description of one layer of a five-layer person.</p>
          ...
          <p><strong>Western Astrology</strong> maps your inner world — the planets, houses, and aspects that shape your psychology, your patterns, and your relational architecture.</p>
