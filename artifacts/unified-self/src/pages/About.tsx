...
export default function About() {
  useSEO({
    title: "About",
    description:
      "Meet the practitioner behind The Unified Spirit and learn how Astrology, Numerology, Human Design, and Gene Keys are woven together into a single, hand-written Soul Blueprint report.",
    path: "/about",
  });
      ...
      <main id="main-content">
        ...
        <div className="ab-promise">
          <div className="ab-promise-inner">
            ...
            <p>This work matters to me because it changed my life. Not in the motivational sense — in the structural sense. It gave me a framework for understanding myself that made everything else make sense. That is what I want to give every person who comes here. Not information. Recognition.</p>
          </div>
        </div>
