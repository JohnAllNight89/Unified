...
export default function DiscoverNumerology() {
  useSEO({
    title: "Numerology Explained",
    description:
      "The history and meaning of numerology — Pythagorean and Chaldean systems, the five core numbers, and Master Numbers, explained in depth.",
